...
export function setupAssociations(sequelize) {
  ...
  if (product && cat_product) {
    ...
    console.warn(
      "[Associations] Could not set up Product <-> CatProduct associations. One or both models undefined.",
    );
  }
  ...
  if (ticket && ticket_details) {
    ...
    console.warn(
      "[Associations] Could not set up Ticket <-> TicketDetails associations. One or both models undefined.",
    );
  }
  ...
  if (ticket_details && product) {
    ...
    console.log(
      "[Associations] TicketDetails <-> Product associations set up.",
    );
  } else {
    console.warn(
      "[Associations] Could not set up TicketDetails <-> Product associations. One or both models undefined.",
    );
  }
  ...
  if (daily_sales && daily_sales_details) {
    ...
    console.log(
      "[Associations] DailySales <-> DailySalesDetails associations set up.",
    );
  } else {
    console.warn(
      "[Associations] Could not set up DailySales <-> DailySalesDetails associations. One or both models undefined.",
    );
  }
  ...
  if (daily_sales_details && product) {
    ...
    console.log(
      "[Associations] DailySalesDetails <-> Product associations set up.",
    );
  } else {
    console.warn(
      "[Associations] Could not set up DailySalesDetails <-> Product associations. One or both models undefined.",
    );
  }
